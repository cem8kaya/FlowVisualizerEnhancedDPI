...
std::optional<S1APMessage> S1APParser::parse(const uint8_t* data, size_t len) {
    ...
    try {
        ...
        LOG_DEBUG("S1AP: Parsing message type " << static_cast<int>(msg.message_type)
        ...
        while (remaining >= 4) {
            ...
            const uint8_t* ie_start = ptr;
            size_t ie_remaining = remaining;
            ...
            S1APCriticality ie_criticality = static_cast<S1APCriticality>(ptr[0] & 0x03);
            ptr++;
            remaining--;
            ...
            if (ptr[0] & 0x80) {
                ...
                if (len_bytes > remaining || len_bytes > 4) {
                    LOG_WARNING("S1AP: Invalid IE length encoding");
                    break;
                }
                ptr++;
                remaining--;
            ...
            if (ie_len > remaining) {
                LOG_WARNING("S1AP: IE length " << ie_len << " exceeds remaining " << remaining);
                break;
            }
            ...
            switch (ie_id) {
                ...
                case constants::IE_ID::EUTRAN_CGI:
                    ...
                    if (msg.eutran_cgi.has_value()) {
                        LOG_DEBUG("S1AP: Parsed EUTRAN-CGI: PLMN=" << msg.eutran_cgi->plmn_identity
                                  << ", CID=" << msg.eutran_cgi->cell_identity);
                    }
                    break;

                case constants::IE_ID::UE_SECURITY_CAPABILITIES:
                    msg.ue_security_capabilities = S1APIEParser::parseUESecurityCapabilities(ie_value, ie_len);
                    break;
                ...
                case constants::IE_ID::RRC_ESTABLISHMENT_CAUSE:
                    msg.rrc_establishment_cause = S1APIEParser::parseRRCEstablishmentCause(ie_value, ie_len);
                    break;
                ...
                case constants::IE_ID::E_RAB_TO_BE_SETUP_LIST_CTXT_SU_REQ:
                    ...
                    // This is a SEQUENCE OF, so we need to parse multiple items
                    {
                        ...
                        while (list_remaining > 4) {
                            auto erab = S1APIEParser::parseE_RAB_ToBeSetupItem(list_ptr, list_remaining);
                            if (erab.has_value()) {
                                msg.e_rab_to_be_setup_list.push_back(erab.value());
                                stats_.e_rabs_extracted++;
                                // Move pointer (simplified - actual advancement depends on ASN.1 encoding)
                                // For now, we'll break after first item to avoid complexity
                                break;
                            } else {
                                break;
                            }
                ...
                case constants::IE_ID::E_RAB_SETUP_LIST_CTXT_SU_RES:
                    // Parse E-RAB list for Initial Context Setup Response
                    {
                        ...
                        while (list_remaining > 4) {
                            auto erab = S1APIEParser::parseE_RAB_SetupItem(list_ptr, list_remaining);
                            if (erab.has_value()) {
...
S1APMessageType S1APParser::mapProcedureCodeToMessageType(uint8_t procedure_code,
    ...
    switch (procedure_code) {
        case 0: return S1APMessageType::HANDOVER_PREPARATION;
        case 1: return S1APMessageType::HANDOVER_RESOURCE_ALLOCATION;
        case 2: return S1APMessageType::HANDOVER_NOTIFICATION;
        case 3: return S1APMessageType::PATH_SWITCH_REQUEST;
        case 4: return S1APMessageType::HANDOVER_CANCEL;
        case 5: return S1APMessageType::E_RAB_SETUP;
        case 6: return S1APMessageType::E_RAB_MODIFY;
        case 7: return S1APMessageType::E_RAB_RELEASE;
        case 9: return S1APMessageType::INITIAL_CONTEXT_SETUP;
        case 10: return S1APMessageType::PAGING;
        case 11: return S1APMessageType::DOWNLINK_NAS_TRANSPORT;
        case 12: return S1APMessageType::INITIAL_UE_MESSAGE;
        case 13: return S1APMessageType::UPLINK_NAS_TRANSPORT;
        case 14: return S1APMessageType::RESET;
        case 15: return S1APMessageType::ERROR_INDICATION;
        case 16: return S1APMessageType::NAS_NON_DELIVERY_INDICATION;
        case 17: return S1APMessageType::S1_SETUP;
        case 18: return S1APMessageType::UE_CONTEXT_RELEASE_REQUEST;
        case 19: return S1APMessageType::DOWNLINK_S1_CDMA2000_TUNNELLING;
        case 20: return S1APMessageType::UPLINK_S1_CDMA2000_TUNNELLING;
        case 21: return S1APMessageType::UE_CONTEXT_MODIFICATION;
        case 22: return S1APMessageType::UE_CAPABILITY_INFO_INDICATION;
        case 23: return S1APMessageType::UE_CONTEXT_RELEASE;
        case 24: return S1APMessageType::ENB_STATUS_TRANSFER;
        case 25: return S1APMessageType::MME_STATUS_TRANSFER;
        case 26: return S1APMessageType::DEACTIVATE_TRACE;
        case 27: return S1APMessageType::TRACE_START;
        case 28: return S1APMessageType::TRACE_FAILURE_INDICATION;
        case 29: return S1APMessageType::ENB_CONFIGURATION_UPDATE;
        case 30: return S1APMessageType::MME_CONFIGURATION_UPDATE;
        case 31: return S1APMessageType::LOCATION_REPORTING_CONTROL;
        case 32: return S1APMessageType::LOCATION_REPORTING_FAILURE_INDICATION;
        case 33: return S1APMessageType::LOCATION_REPORT;
        case 34: return S1APMessageType::OVERLOAD_START;
        case 35: return S1APMessageType::OVERLOAD_STOP;
        case 36: return S1APMessageType::WRITE_REPLACE_WARNING;
        case 37: return S1APMessageType::ENB_DIRECT_INFORMATION_TRANSFER;
        case 38: return S1APMessageType::MME_DIRECT_INFORMATION_TRANSFER;
        default:
            LOG_WARNING("S1AP: Unknown procedure code " << static_cast<int>(procedure_code));
